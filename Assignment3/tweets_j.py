...
if __name__ == '__main__':
        ...
        access_token = "1004036112178995203-f3PGviIQi5aicGqMmZZQ1Llp2Iw6Bj"
        access_token_secret = "cdRtWfGHtrIbE68P6NuanTNX183TxjSkwNedqtUQKUVhg"

        # Local connection
        host = "172.31.3.247"          # Get local machine name (copy internal address from EC2 instance).
        port = 5512                 # Reserve a port for your service.
